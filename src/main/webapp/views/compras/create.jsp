...
<body>
	...
	<main>
		<header class="header">
			<h1 class="text-center mt-5">Criar Nova compra</h1>
		</header>
			...
			<div class="container py-3">
				<form action="../../compra-create">
					<div class="form-group mb-3">
						<label for="data_compras" class="form-label"> Data compras
						</label> <input type="text" id="data_compras" name="data_compras"
							class="form-control" value="" />
					</div>

					<div class="form-group mb-3">
						<label for="destino_pacotes" class="form-label">
							Destino do pacotes </label> <input type="text" id="destino_pacotes"
							name="destino_pacotes" class="form-control" value="" />
					</div>

					<div class="form-group mb-3">
						<label for="periodo_pacotes" class="form-label">
							Periodo do pacotes </label> <input type="text" id="periodo_pacotes"
