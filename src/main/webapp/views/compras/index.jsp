...
<body>
	...
	<main>
		<header class="header">
			<h1 class="text-center mt-5">Compras</h1>
		</header>
		...
		<section class="container cliente-crud">
			<div class="p-4">
				<table class="table table-responsive table-hover">
					<thead class="table-dark">
						<tr>
							...
							<th scope="col">Periodo_viagem</th>
							<th scope="col">Ações</th>
						</tr>
					</thead>
					<tbody>

						<jstl:forEach items="${listaCompras}" var="co">
							<tr>
								<td>${co.id_compras}</td>
								<td>${co.data_compras}</td>
								<td>${co.destino_pacotes}</td>
								<td>${co.periodo_pacotes}</td>
								<td>
									<div class="d-flex">
										<a href="compra-edit?id=${co.id_compras}" class="mx-1" title="Editar">
											<i class="ri-file-edit-line"></i>
										</a> <a href="compra-delete?id=${co.id_compras}" class="mx-1"
											title="Cancelar"
											onclick="return confirm('Deseja excluir o autor ${co.destino_pacotes}.')">
				...
				<div class="d-flex justify-content-end mt-4">
					<a href="./views/compras/create.jsp"
						class="btn btn-success mb-2 botao1"> Nova compra </a>
				</div>
			</div>
		</section>
	</main>
