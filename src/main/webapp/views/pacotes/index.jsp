...
<body>
	...
	<main>
		<header class="header">
			<h1 class="text-center mt-5">Pacotes de Viagem</h1>
		</header>
			...
			<div class="p-4">
				<table class="table table-responsive table-hover">
					<thead class="table-dark">
						<tr>
							<th scope="col">Id_pacotes</th>
							<th scope="col">Periodo_pacotes</th>
							<th scope="col">Destino_pacotes</th>
							<th scope="col">preco_pacotes</th>
					...
					<tbody>
						...
						<jstl:forEach items="${listaPacotes}" var="p">
							<tr>
								<td>${p.id_pacotes}</td>
								<td>${p.periodo_pacotes}</td>
								<td>${p.destino_pacotes}</td>
								<td>${p.preco_pacotes}</td>
								<td>
									<div class="d-flex">
										<a href="pacotes-edit?id=${p.id_pacotes}" class="mx-1"
											title="Editar"> <i class="ri-file-edit-line"></i>
										</a> <a href="pacotes-delete?id=${p.id_pacotes}" class="mx-1"
											title="Cancelar"
											onclick="return confirm('Deseja excluir o autor ${p.destino_pacotes}.')">
				...
				<div class="d-flex justify-content-end mt-4">
					<a href="./views/pacotes/create.jsp"
						class="btn btn-success mb-2 botao1"> Novo pacote </a>
				</div>
			</div>
		</section>
	</main>
