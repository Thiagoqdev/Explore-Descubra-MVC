...
<body>
	...
	<main>
		<header class="header">
			<h1 class="text-center mt-5">Criar Pacotes de viagens</h1>
		</header>
			...
			<div class="container py-3">
				<form action="../../compras-create">
					<div class="form-group mb-3">
						<label for="periodo_pacotes" class="form-label"> Periodo do
							pacote de viagem </label> <input type="text" id="periodo_pacotes"
							name="periodo_pacotes" class="form-control" value="" />
					</div>

					<div class="form-group mb-3">
						<label for="destino_pacotes" class="form-label"> Destino
							do pacote de viagem </label> <input type="text" id="destino_pacotes"
							name="destino_pacotes" class="form-control" value="" />
					</div>

					<div class="form-group mb-3">
						<label for="preco_pacotes" class="form-label"> Preço do
							pacote de viagem </label> <input type="number" id="preco_pacotes"
							name="preco_pacotes" class="form-control" value="" />
					</div>
