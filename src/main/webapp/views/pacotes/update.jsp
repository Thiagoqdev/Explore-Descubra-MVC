...
<body>
	...
	<main>
		<header class="header">
			<h1 class="text-center mt-5">Atualizar Pacotes de viagens "${pacotes.destino_pacotes}" </h1>
		</header>
			...
			<div class="container py-3">
				<form action="./pacotes-update">
					<input type="hidden" id="id" name="id" class="form-control"
						value="${pacotes.id_pacotes}" />

					<div class="form-group mb-3">
						<label for="periodo_pacotes" class="form-label"> periodo_pacotes </label> <input
							type="text" id="periodo_pacotes" name="periodo_pacotes" class="form-control"
							value="${pacotes.periodo_pacotes}" />
					</div>

					<div class="form-group mb-3">
						<label for="destino_pacotes" class="form-label"> destino_pacotes </label> <input
							type="text" id="destino_pacotes" name="destino_pacotes" class="form-control"
							value="${pacotes.destino_pacotes}" />
					</div>

					<div class="form-group mb-3">
						<label for="preco_pacotes" class="form-label"> preço dos pacotes </label> <input
							type="number" id="preco_pacotes" name="preco_pacotes" class="form-control"
							value="${pacotes.preco_pacotes}" />
					</div>
